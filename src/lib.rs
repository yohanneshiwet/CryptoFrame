...
#[derive(Debug)]
pub struct CryptoFrameXProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoFrameXProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoFrameX processing");
    
    let mut processor = CryptoFrameXProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoFrameXProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoFrameXProcessor::new(false);
